...
namespace VRTK
{
    ...
    public class VRTK_InteractGrab : MonoBehaviour
    {
        ...
        // Custom
        public event CustomObjectInteractEventHandler ControllerPrimaryGrabInteractableObject;
        public event CustomObjectInteractEventHandler ControllerPrimaryUngrabInteractableObject;
        public event CustomObjectInteractEventHandler ControllerSecondaryGrabInteractableObject;
        public event CustomObjectInteractEventHandler ControllerSecondaryUngrabInteractableObject;
        ...
        protected virtual void Update()
        {
            ...
            if (grabbedObject != null && grabbedObject.transform.parent == null) {
                Debug.LogError("Releasing gun that got detached");
                ForceRelease();
            }
        }
...
#pragma warning restore 0618
        ...
        protected virtual void InitPrimaryGrab(VRTK_InteractableObject currentGrabbedObject)
        {
            ...
            // Custom
            if (ControllerPrimaryGrabInteractableObject != null) {
                ControllerPrimaryGrabInteractableObject(this, currentGrabbedObject.gameObject);
            }
        ...
        protected virtual void InitUngrabbedObject(bool applyGrabbingObjectVelocity)
        {
            if (grabbedObject != null && interactTouch != null)
            {
                ...
                // Custom
                if (influencingGrabbedObject) {
                    if (ControllerSecondaryUngrabInteractableObject != null) {
                        ControllerSecondaryUngrabInteractableObject(this, grabbedObject);
                    }
                } else {
                    // Custom
                    if (ControllerPrimaryUngrabInteractableObject != null) {
                        ControllerPrimaryUngrabInteractableObject(this, grabbedObject);
                    }
                }
            }
